...
if (\Contao\System::getContainer()) { // Sicherstellen, dass der Container verfügbar ist
...
PaletteManipulator::create()
    ->addField('detailTitle', 'headline', PaletteManipulator::POSITION_AFTER)

    ->addLegend('author_legend', 'date_legend', PaletteManipulator::POSITION_AFTER)
    ->addField(['postAuthor', 'authorTitle', 'authorImage'], 'author_legend', PaletteManipulator::POSITION_APPEND)

    ->addLegend('article_legend', 'author_legend', PaletteManipulator::POSITION_AFTER)
    ->addField(['readingTime', 'articleStatus'], 'article_legend', PaletteManipulator::POSITION_APPEND)

    ->addLegend('downloads_legend', 'article_legend', PaletteManipulator::POSITION_AFTER)
    ->addField(['pdfDownload', 'infographicDownload'], 'downloads_legend', PaletteManipulator::POSITION_APPEND)

    ->addField('listImage', 'image_legend', PaletteManipulator::POSITION_PREPEND)
    ->addField('multiSRC', 'image_legend', PaletteManipulator::POSITION_APPEND)
