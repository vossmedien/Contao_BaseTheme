...
// contao/languages/de/tl_calendar_events.php

$GLOBALS['TL_LANG']['tl_calendar_events']['isSoldOut'] = ['Ausgebucht', 'Veranstaltung ist ausgebucht'];
$GLOBALS['TL_LANG']['tl_calendar_events']['eventTime'] = ['Veranstaltungsbeginn', 'Uhrzeit der Veranstaltung'];
$GLOBALS['TL_LANG']['tl_calendar_events']['priceAdvance'] = ['Vorverkaufspreis', 'Preis im Vorverkauf'];
