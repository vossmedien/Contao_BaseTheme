...
return array(
    'label' => array('Custom | Downloads (downloads)', ''),
    'types' => array('content'),
    ...
    'fields' => array(
        ...
        'settings_downloads' => array(
            'label' => array('Downloads', ''),
            'inputType' => 'group',
        ),

        'element_type' => array(
            'label' => array('Art der Downloadverwaltung', ''),
            'inputType' => 'radio',
            'options' => array(
                '1' => 'Ordner angeben und alle darin befindlichen Dateien auflisten bzw. Dateien über Filepicker einzeln auswählen',
                //'2' => 'Dateien und Datei-Informationen je Download pflegen',
            ),
        ),
