...
return array(
    'label' => array('Custom | Full-Width Störer (fullwidthstoerer v1)', ''),
    'types' => array('content'),
    ...
    'fields' => array(
        ...
        'animation_type' => array(
            'label' => array(
                'de' => array('Art der Einblendeanimation (Element)', 'Siehe https://animate.style/ für Beispiele'),
            ),
            'inputType' => 'select',
            'options' => array(
                /* Fading entrances  */
        ...
        'animation_type_image' => array(
            'label' => array(
                'de' => array('Art der Einblendeanimation (Bild)', 'Siehe https://animate.style/ für Beispiele'),
            ),
            'inputType' => 'select',
            'options' => array(
                /* Fading entrances  */
        ...
        'animation_type_content' => array(
            'label' => array(
                'de' => array('Art der Einblendeanimation (Text)', 'Siehe https://animate.style/ für Beispiele'),
            ),
            'inputType' => 'select',
            'options' => array(
                /* Fading entrances  */
