...
return array(
    ...
    'fields' => array(
        ...
        'show_bottombtn' => array(
            'label' => array('Button "nach unten"-scrollen anzeigen', ''),
            'inputType' => 'checkbox',
            'eval' => array('tl_class' => ' clr'),
        ),

        'custom_anchor' => array(
            'label' => array('Eigenen Anker-Link nutzen', 'Standardmäßig wird zum zweiten Artikel gescrollt'),
            'inputType' => 'text',
            'eval' => array('tl_class' => 'w50'),
            'dependsOn' => array(
                'field' => 'show_bottombtn',
            ),
        ),
